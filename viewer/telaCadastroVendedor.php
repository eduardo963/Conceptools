...
<div class="col-md-6">
    <div>
        <form method="post"><strong>Nome: </strong>
            ...
            <input class="form-control" type="text" name="genero" maxlength="10" minlength="1" autocomplete="off" inputmode="numeric"><strong>Data de nascimento: </strong>
            <input class="form-control" type="text" name="datadenascimento" maxlength="10" minlength="1" autocomplete="off" inputmode="numeric"><strong>Data de admissão: </strong>
            <input class="form-control" type="text" name="datadeadmissao" maxlength="10" minlength="1" autocomplete="off" inputmode="numeric"><strong>Telefone: </strong>
