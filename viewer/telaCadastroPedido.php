...
<div class="col-md-3">
    ...
    <form method="post">
        ...
        <button class="btn btn-default btn-block" type="submit" name="tipo" value="concluir"><strong>Concluir
                Pedido</strong></button>
        <button class="btn btn-default btn-block" type="submit" name="tipo" value="cancelar"><strong>Cancelar
                Pedido</strong></button>
    </form>
</div>
<div class="col-md-5">
            ...
            <div>
                ...
                <form method="post">
                    ...
                    <input class="form-control" name="nomeProduto" type="text" placeholder="Nome do produto"
                           autofocus="" autocomplete="on"><strong>Codigo do produto: </strong>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <tbody>
                    <?php
                    $produtos = $controler->buscarProdutos($nome, $codigo);


                    if ($produtos) {
                        foreach ($produtos as $linhaAtual) {
