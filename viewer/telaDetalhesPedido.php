...
<div class="col-md-3">
    ...
    <form method="get">
        ...
        ?>
        <button class="btn btn-default btn-block" name="action" value="excluirPedido" type="submit"><strong>Excluir
...
<div class="col-md-9">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
            <?php
            $arrayDeProdutos = $controler->listarProdutosDoPedido($id);

            foreach ($arrayDeProdutos as $produto) {
